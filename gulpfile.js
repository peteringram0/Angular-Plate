...
gulp.task('watch', ['browser-sync'], function(){
  gulp.watch('build/styles/**/*.scss', ['styles', 'bs-reload']);
  gulp.watch('build/**/*.js', ['scripts', 'bs-reload']);
  gulp.watch('build/images/**/*.*', ['images', 'bs-reload']);
  gulp.watch('build/**/*.tpl.html', ['html', 'bs-reload']);
});
